...
DMS_MinDistFromWestBorder			= 7500;	// There's at least 2km of ocean from the west edge to the first bit of land.
DMS_MinDistFromEastBorder			= 7300;	// There's over 3km of ocean from the east edge to the first bit of land.
DMS_MinDistFromSouthBorder			= 4800;	// There's about 4.8km of ocean from the south edge to the first bit of land.
DMS_MinDistFromNorthBorder			= 4600;	// There's around 750m of ocean from the north edge to the first bit of land (including the island).
